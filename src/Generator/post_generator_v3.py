from src.Generator.prompt_builder_v3 import PromptBuilder
...
class PostGenerator:
    def __init__(self):
        self.llm = llm
        self.prompt_builder = PromptBuilder("config/prompt_config_v3.yaml")
...
if __name__ == "__main__":
    ...
    for i, post in enumerate(result["few_shot_examples"], 1):
        print(f"\n EXAMPLE {i}")
        print(post["text"])
# python3 -m src.Generator.post_generator_v3
